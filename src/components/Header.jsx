...
const Header = () => {
  ...
  // Check if current route is dashboard (user or admin)
  ...
  return (
    <>
      {/* Fixed top wrapper: banner + header */}
                  ...
                  <>
                    ...
                    <div className="absolute right-0 top-full mt-3 w-[260px] bg-white rounded-xl shadow-[0_8px_30px_rgba(0,0,0,0.12)] border border-gray-100 py-1 z-50">
                      ...
                      <a
                        ...
                        className="block px-6 py-4 text-[15px] text-gray-700 hover:bg-gray-50 transition-colors border-b border-gray-100"
                      ...
                      >
                        ...
                        <span className="block text-[13px] text-gray-400 mt-0.5">Manage offers on my cars</span>
                      </a>
                      <button
                        onClick={async () => {
                        ...
                        className="block w-full text-left px-6 py-4 text-[15px] text-gray-700 hover:bg-gray-50 transition-colors"
                      >
                        Sign out
                      </button>
                    </div>
            ...
            <div className="flex items-center gap-2">
              {user ? (
                <button
                  ...
                  className="text-[14px] font-medium bg-red-500 text-white px-5 py-2 rounded-full"
                >
                  Sign Out
                </button>
              ) : (
            ...
            {user && (
              <div className="border-t border-gray-100 pt-4 mt-1 flex flex-col gap-1">
                <a
                  href={user.role === "ADMIN" ? "/admin-dashboard" : "/dashboard"}
                  onClick={() => setIsOpen(false)}
                  className="block px-4 py-3 text-[15px] text-gray-700 hover:bg-gray-50 rounded-lg transition-colors"
                >
                  My account
                </a>
                <a
                ...
                >
                  <span className="block text-[15px] text-gray-700">My cars</span>
                  <span className="block text-[12px] text-gray-400 mt-0.5">Manage offers on my cars</span>
                </a>
              </div>
            )}
          </div>
      ...
      {/* Spacer for fixed header + optional banner */}
      {showBanner && !isCarDetailPage && !isDashboard ? (
