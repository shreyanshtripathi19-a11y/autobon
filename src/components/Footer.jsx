            ...
            >
              ...
              {section.title === "Contact Us" && (
                <div className="flex gap-4 mt-4">
                  ...
                  <Link
                    target="__blank"
                    href={"https://www.tiktok.com/@autobon.ca?_r=1&_t=ZS-94oCWAMgEbI"}
                  >
                    <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 text-black hover:text-primary cursor-pointer transition-colors">
