      ...
      <div className="py-8 md:py-12">
        ...
        <div className="text-gray-500 my-4 text-xs md:text-sm flex flex-col gap-y-4">
          ...
          <p>
            ...
            unconditional acceptance of the most current version of these Terms
            of Use.
          </p>
          <p>
          ...
          <p>
            ...
            governed by separate agreements, including AUTOBON’s General Terms
            of Service and Privacy Policy.
          </p>
          <p>
            In the event of a conflict, the applicable service-specific
          ...
          <p>
            ...
            updated version on the Website. Changes take effect immediately
          ...
          <p>
            ...
            disclosure, and retention of personal information as described in
            the AUTOBON Privacy Policy, as amended from time to time.
          </p>
          <h3 className="font-medium text-black text-base">
          ...
          <p>
            ...
            obtaining advice from qualified professionals before making
            decisions based on information obtained through the Website.
          </p>
          <h3 className="font-medium text-black text-base">
          ...
          <p>
            All content, software, technology, data, and materials available on
            or through the Website are owned by or licensed to AUTOBON and are
          ...
          <p>
            AUTOBON does not control, endorse, or assume responsibility for
            Linked Sites, their content, or their privacy practices. Your use of
            Linked Sites is at your own risk.
          </p>
          ...
          <p>
            ...
            IS”, “AS AVAILABLE”, AND “WITH ALL FAULTS”, WITHOUT WARRANTIES OF
            ANY KIND, WHETHER EXPRESS, IMPLIED, OR STATUTORY. AUTOBON DISCLAIMS
            ALL WARRANTIES INCLUDING, WITHOUT LIMITATION, ACCURACY,
            COMPLETENESS, FITNESS FOR A PARTICULAR PURPOSE, NON-INFRINGEMENT,
            AVAILABILITY, AND SECURITY. YOUR SOLE REMEDY FOR DISSATISFACTION
            WITH THE WEBSITE IS TO DISCONTINUE USE.
          </p>
          <h3 className="font-medium text-black text-base">
          ...
          <p>
            Termination does not affect rights or obligations that arose prior
            to termination.
          </p>
          <h3 className="font-medium text-black text-base">
            14. Governing Law
          ...
          <p>
            ...
            Jurisdiction – e.g., Ontario, Canada / India / UAE], without regard
          ...
          <p>
            ...
            Website shall be resolved through arbitration or courts as required
          ...
          <p>
            ...
            valid. Failure to enforce any provision is not a waiver. You may not
            assign these Terms without AUTOBON’s written consent.
          </p>
